...
exports.writeModel = exports.togglePoopBag = exports.modScene = exports.modFox = void 0;
...
const writeModel = function writeModel(text = "") {
...
const gameState = {
  ...
  die() {
    ...
    (0, _ui.modFox)("dead");
    this.clearTimes();
    (0, _ui.writeModel)("The fox died. <br/> Press the middle button to start");
  },
...
function initButtons(handleUserAction) {
  ...
  function buttonClick({
    ...
    if (target.classList.contains("left-btn")) {
      ...
      selelctedIcon = (2 + selelctedIcon) % _constants.ICONS.length;
      toggleHighlighted(selelctedIcon, true);
    } else if (target.classList.contains("right-btn")) {
      toggleHighlighted(selelctedIcon, false);
      selelctedIcon = (1 + selelctedIcon) % _constants.ICONS.length;
      toggleHighlighted(selelctedIcon, true);
    } else {
      handleUserAction(_constants.ICONS[selelctedIcon]);
    }
  }
